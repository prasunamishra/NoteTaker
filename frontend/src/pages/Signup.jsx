...
function Signup({ onLoginSuccess }) {
  ...
  useEffect(() => {
    document.title = 'Sign Up - Notes Studio';
  }, []);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-radial from-slate-900 via-slate-950 to-black px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="pointer-events-none absolute top-1/4 right-1/4 h-72 w-72 rounded-full bg-violet-500/10 blur-3xl"></div>
      <div className="pointer-events-none absolute bottom-1/4 left-1/4 h-96 w-96 rounded-full bg-indigo-600/10 blur-3xl"></div>
        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Start writing secure, clean notes today
            </p>
          </div>
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-300" htmlFor="confirm-password">
                  Confirm Password
                </label>
                <div className="mt-1">
                  <input
